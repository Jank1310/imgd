...
var Post = React.createClass({
  render: function () {
    ...
    var channelText = '/c/' + this.props.data.channel;
    return (
        <div className="ui card post">
          <div className="content">
            ...
            <div className="right floated">
              <div className="right aligned">
                <strong><Link to={channelUrl}>{channelText}</Link></strong>
              </div>
              <div className="right aligned meta">{timeStr}</div>
            </div>
          </div>
          ...
          <div className="content">
            <span className="right floated">
              <i className="large heart outline like icon"></i>
